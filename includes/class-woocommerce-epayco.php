     ...
     public function receipt_page($order_id)
            {
              ...
              // die();
               echo('
                ...
                ',$this->epayco_publickey, $order->get_total(),$tax,$base_tax, $descripcion, $descripcion, $currency, $order->get_id(), $basedCountry, $test_mode, 'false', $redirect_url,$confirm_url,
